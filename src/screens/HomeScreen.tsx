...
const s = StyleSheet.create({
  ...
  dotsRow: { flexDirection: 'row', gap: 7, marginBottom: 10 },
  ...
  title: { fontFamily: 'Fredoka_700Bold', fontSize: 44, lineHeight: 44, letterSpacing: 0.5 },
  tagline: {
    fontFamily: 'Poppins_400Regular', fontSize: 13, lineHeight: 19,
    maxWidth: 320, marginTop: 10, marginBottom: 18,
  },
  taglineBold: { fontFamily: 'Poppins_700Bold' },
  buttons: { width: 240, gap: 10 },
  playBtn: {
    padding: 12, borderRadius: 13, borderWidth: 1, alignItems: 'center',
  ...
  secondaryBtn: { flex: 1, padding: 9, borderRadius: 12, borderWidth: 1, alignItems: 'center' },
