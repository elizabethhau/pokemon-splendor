  ...
  return (
    ...
    >
      <View style={{ flexDirection: 'row', alignItems: 'center', gap: z(13) }}>
        {opponents.map(({ p, i }) => (
          <View key={p.id} style={{ flexDirection: 'row', alignItems: 'center', gap: z(7) }}>
            <View style={{
              width: z(27), height: z(27), borderRadius: z(14), backgroundColor: '#4a5066',
              borderWidth: 2, borderColor: 'rgba(255,255,255,0.25)',
              alignItems: 'center', justifyContent: 'center', overflow: 'hidden',
            }}>
              <ArtworkImage dex={p.isAI ? AI_AVATAR_DEX[(i - 1) % AI_AVATAR_DEX.length] : SEAT_AVATAR_DEX[i % SEAT_AVATAR_DEX.length]} style={{ width: z(25), height: z(25) }} />
            </View>
            <View>
